// Simple sidereal clock Javascript.
// Based on a modified version of http://community.dur.ac.uk/john.lucey/users/lst.html

function calculate_clock() {
// longitude is on global file site.js
//     var longit = -70.806525;
    ...
    document.getElementById('utc_clock').innerHTML = cuth + ":"  +cutm+":"+cuts;
	document.getElementById('lst_clock').innerHTML = ch + ":"  + cmin  + ":" +csecs;
	
	setTimeout("calculate_clock()",997);
